...
Wraps HuggingFace transformers (https://github.com/huggingface/transformers) models for use as a 
text tower in CLIP model.
"""
import re
...
class ClsPooler(nn.Module):
    ...
    def forward(self, x: BaseModelOutput, attention_mask: TensorType):
        if (
            self.use_pooler_output and isinstance(
...
class HFTextEncoder(nn.Module):
    ...
    def __init__(
        ...
        if config is None:
            ...
            create_func, model_args = (AutoModel.from_pretrained, model_name_or_path
    ...
    def forward(self, x: TensorType):
        ...
        tokens = (
            ...
            if type(self.pooler) == ClsPooler else out.last_hidden_state
        )
