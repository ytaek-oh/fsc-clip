...
from .model import (
    CLIP, CustomTextCLIP, convert_to_custom_text_state_dict, convert_weights_to_lp, get_cast_dtype,
    resize_pos_embed, resize_text_pos_embed, set_model_preprocess_cfg,
)
from .openai import load_openai_model
from .pretrained import (
    download_pretrained, download_pretrained_from_hf, get_pretrained_cfg,
    list_pretrained_tags_by_model,
)
from .tokenizer import DEFAULT_CONTEXT_LENGTH, HFTokenizer, SimpleTokenizer
from .transform import (
    AugmentationCfg, PreprocessCfg, image_transform_v2, merge_preprocess_dict,
    ...
    **model_kwargs,
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        model = load_openai_model(
            model_name, precision=precision, device=device, cache_dir=cache_dir, **model_kwargs
        )
    else:
...
def create_model_and_transforms(
    ...
    **model_kwargs,
    ...
    preprocess_train, preprocess_val = create_transforms(
        model.visual.preprocess_cfg, aug_cfg=aug_cfg
    )
    return model, preprocess_train, preprocess_val


def create_transforms(preprocess_cfg, aug_cfg=None):
