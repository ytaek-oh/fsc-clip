...
from .pretrained import (
    download_pretrained_from_url, get_pretrained_url, list_pretrained_models_by_tag,
)
    ...
    **model_kwargs,
    ...
    try:
        model = build_model_from_openai_state_dict(
            state_dict or model.state_dict(), cast_dtype=cast_dtype, **model_kwargs
        )
    except KeyError:
        sd = {k[7:]: v for k, v in state_dict["state_dict"].items()}
        model = build_model_from_openai_state_dict(sd, cast_dtype=cast_dtype, **model_kwargs)
